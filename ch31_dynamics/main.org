...
The second part is more enigmatic: those are "velocity product terms", which involve partial derivatives of the mass matrix, thereby accounting e.g. for configuration changes of a chain of segments.
