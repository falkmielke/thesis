...
take any 3D point \(D\) with 4D coordinates \(0, a, b, c\), e.g. the door handle point from our example: after rotation, it will be \(D_{rot}\), which can be calculated by.
