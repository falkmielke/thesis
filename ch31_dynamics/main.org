...
Hence, the practical strategy TODO citep:Robertson2013,Lynch2017 is to start at the most distal limb segment (e.g. the foot-toe complex), and measure its movement and ground contact wrench.
...
The proximal joint wrench, shifted to the joint position and inverted in sign (Newton's \(n^{th}\) law), is an input for calculating the balance of the proximally adjacent segment.

TODO figure as in Dumas
