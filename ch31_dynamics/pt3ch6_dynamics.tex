...
\label{sec:org51408c7}
\subsection{A Momentum Experiment}
\label{sec:orgbce4846}
...
\label{sec:orgb9e1794}
\subsection{Forward and Inverse Problems}
\label{sec:org0659e74}
...
The time derivative of angular momentum is called moment (\(M\); see also: \citet{WikipediaNewtonEuler,WikipediaTorque} and below), and with further manipulation \citep[details in][, p. 242, eqn. 8.23; Fig. \ref{fig:miracle}]{Lynch2017} yields:
...
\label{sec:org6deaf09}

\subsection{Generic Approach}
\label{sec:org223bf40}
