...
The data set has been analyzed before \citep[currently under review, ][]{Druelle2021prep}, and the purpose of another upcoming manuscript is to extend the analysis to questions of /posture/ and /coordination/.
...
+ Kinematics are processed with a previously established technique \citep["Fourier Coefficient Affine Superimposition", cf.][]{Mielke2019}.
