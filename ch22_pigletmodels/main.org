...
# TITLE: Locomotor Development Diagnostics in Postnatal Piglets Using Probabilistic Predictive Modeling
...
TODO: funding info, contributions
TODO: re-check model comparison (better on the supercomputer)
TODO: upload data upon publication
