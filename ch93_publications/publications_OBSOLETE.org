...
#+EXPORT_FILE_NAME: publications_obsolete
...
@@latex:\let\section\subsection@@
@@latex:\let\subsection\subsubsection@@
@@latex:\begin{change}@@
...
@@latex:\let\subsection\section@@
@@latex:\let\subsubsection\subsection@@
