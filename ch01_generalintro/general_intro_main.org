...
We can witness the birth of another living being, measure and compare parameters around.
...
And we can attempt to quantify which environmental effects have influenced the process.
