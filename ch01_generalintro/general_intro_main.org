...
#+CAPTION: The "bing chat" prompt which lead to the introductory limerick (Nov 3rd, 2023). Besides the use of "DeepLabCut" for landmark tracking, this poem and the steampunk figure above are the only AI contributions to my thesis.
#+ATTR_LATEX: :placement [p] :width 16cm
#+LABEL: fig:limerick
