...
This thesis set out to investigate in detail the putative deficits of piglets with lower-than-normal birth weight in locomotor development.
...
Which makes it even more interesting, but also challenging to present to a broad public.
...
The purpose of this thesis is to assemble, extend, and scientifically evaluate the different facets of current research around locomotor development.
