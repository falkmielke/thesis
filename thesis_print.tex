...
\fancyhead[RO]{ \vspace{-1.cm}
 \raisebox{1.0cm}[0cm][0cm]{\fbImageF{./flipbook/frames/p}{pdf}{height=1cm}}
}
...
\newcommand\chng[1]{#1}
\newcommand\flipbookexplain{For illustration, the "flipbook" on the upper right header of this thesis will show an average carpus joint angle profile, changing in phase, mean, and amplitude. }
...
\makeatletter
    ...
    \begin{spacing}{2}
        \begin{center}
            {\includegraphics[width=4cm]{figures/UA-hor-1-nl-rgb.pdf} 
              \\[4ex]}
...
\makeatletter
    ...
    \begin{footnotesize}
        \vspace*{\fill}
            ...
            \\ Methodologische vooruitgang bij het bestuderen van postnatale bewegingsontwikkeling % \vspace*{-0.3cm}\\ 
            \vspace{1cm}\\
            ...
            \end{tabular}}
            \begin{flushright}
                \vspace{-1cm}\includegraphics[height=4cm]{figures/schweinchen_left.jpg}
            \end{flushright}
            \end{footnotesize}
        \end{spacing}
\makeatother
...
\input{ch94_misc/acknowledgements.tex}
