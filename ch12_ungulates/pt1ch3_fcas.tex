...
At low values of PC1, the relative elbow profiles (no. 1) are ``sawtooth-like'' curves with steeply sloped, increasing \chng{joint} angles \chng{during stance phase}.
...
This can be explained by the character of the data: we look at relative elbow profiles at voluntarily walking animals.
