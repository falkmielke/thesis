...
Because we are interested in dynamic temporal changes relative to the mean angles, we \chng{isolate} differences in $c_0$ by subtracting it from the profiles, despite acknowledging that posture or average angle might affect the dynamics.
