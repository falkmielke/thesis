...
To characterize light which is emitted, reflected, or absorbed, one can plot a spectrum (Fig. \ref{fig:spectrum}) \footnote{\chng{Patient readers of this thesis will see a connection to Fourier methods (Ch. \ref{cpt:fourier_review}).}}.
...
\label{sec:orgae5307e}
\subsection{The Flying Femur}
\label{sec:orgd9e6f1e}
...
\clearpage
\section{Discussion}
\label{sec:org219fe93}
\subsection{Density and Attenuation}
\label{sec:org942ac26}
