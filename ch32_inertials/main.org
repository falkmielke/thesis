...
Put simply, applying a red-pass filter sheet will change the composition of the passing light by blocking all the "non-red" photons.
...
X-rays are also photons, just at a different wavelength (range \(10\ pm -- 10\ nm\)).
...
This causes a gradual change of the spectrum, which will shift towards higher average energy.
...
After the experiment, the femur was subjected to a calibrated micro-CT scan at a local micro-CT facility (FleXCT, imec-VisionLab, University of Antwerp, Belgium).
...
|----------------------+--------------+----------------+-----------+---------------------+---------------------+---------------------|
| *parameter*            | *input*        | *\(\sum_{i}m_{i}\)* | *\(\Delta COM\)* |          *\(I_{xx}\)* |          *\(I_{yy}\)* |          *\(I_{zz}\)* |
