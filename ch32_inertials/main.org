...
Note that this scan was historically performed prior to the density calibration experiments, and thus the only available calibration points were air, water, and two density calibration phantoms.
Consequently, an exponential regression was used to convert gray values to density.

This virtual density conversion leads to an over-estimation of the mass of the specimen.
...
#+begin_table
|----------------------+--------------+----------+-----------+--------------+--------------+--------------|
| *parameter*            | *change*       | \(\sum_{i}m_{i}\) | \(\Delta COM\) | \(I_x\)      | \(I_y\)      | \(I_z\)      |
|                      |              |  \([g]\) |  \([px]\) | \([kg m^2]\) | \([kg m^2]\) | \([kg m^2]\) |
|----------------------+--------------+----------+-----------+--------------+--------------+--------------|
|----------------------+--------------+----------+-----------+--------------+--------------+--------------|
| *(reference)*          | none         |      6.4 |         0 |              |              |              |
|----------------------+--------------+----------+-----------+--------------+--------------+--------------|
| *regression \(a\)*     | \(+5\%\)     |      6.1 |           |              |              |              |
| *regression \(b\)*     | \(+5\%\)     |      6.1 |           |              |              |              |
|----------------------+--------------+----------+-----------+--------------+--------------+--------------|
