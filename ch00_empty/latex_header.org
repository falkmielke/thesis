...
% HEADER
#+LATEX_HEADER: \usepackage[american]{babel} % document language
...
#+LATEX_HEADER:  \usepackage{array}		% cell heights
...
#+LATEX_HEADER:  \usepackage[]{lineno} 		% line numbers
...
#+LATEX_HEADER: \input{latex_definitions.tex}
